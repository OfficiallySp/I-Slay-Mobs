...
import com.officiallysp.islaymobs.procedures.ResetExecutedProcedure;
...
public class ResetcommandCommand extends ISlayMobsModElements.ModElement {
	public ResetcommandCommand(ISlayMobsModElements instance) {
		super(instance, 10);
	}
	...
	private int execute(CommandContext<CommandSource> ctx) {
		...
		if (entity != null) {
			...
			});
			{
				...
				ResetExecutedProcedure.executeProcedure($_dependencies);
			}
		}
		return 0;
	}
